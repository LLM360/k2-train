...
def core_transformer_config_from_args(args):
    ...
    kw_args['normalization'] = args.normalization
    kw_args['layernorm_epsilon'] = args.layernorm_epsilon
...
def _add_network_size_args(parser):
    ...
    group.add_argument('--use-gated-mlp', action='store_true')
    return parser
...
def _add_training_args(parser):
    ...
    group.add_argument('--wandb-proj-name', type=str, default='project_k2',
                       help='Write TensorBoard logs to this directory.')
...
def _add_data_args(parser):
    ...
    group.add_argument('--data-path', nargs='*', default=None,
                       ...
                       '--*-data-path args')
    group.add_argument('--data-base-path', type=str, default="./",
                       help='Path to the base dir of the training dataset.')
    ...
    group.add_argument('--n-chunks', type=int, default=8,
                       help='The total number of data chunks.')
