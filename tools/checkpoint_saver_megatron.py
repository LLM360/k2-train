# EXAMPLE1: python tools/checkpoint_saver_megatron.py --megatron-path ./llama-160m-from-hf-tensor2-pipeline2 --target-tensor-parallel-size 1 --target-pipeline-parallel-size 1
import argparse
